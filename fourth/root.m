...
save('start_position/coronal_1.mat', 'start_position');
close all;
clearvars -except triallist
%%
startfile='start_position/coronal_1.mat';
firstpath='ampsfiltds';
triallist=[7:14];
do_tapad_ds_base
clearvars -except triallist
...
startpath=[basepath, pathchar, 'ampsfiltdsadj1', pathchar, 'velrep', pathchar, 'rawpos']
